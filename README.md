About progressbar2-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/progressbar2-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/progressbar2-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/progressbar2-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add progressbar2
# for installing globally
pixi global install progressbar2
```
...
It is possible to list all of the versions of `progressbar2` available on your platform:
...
```
mamba search progressbar2 --channel conda-forge
```
...
```
pixi search progressbar2 --channel conda-forge
```
...
mamba repoquery search progressbar2 --channel conda-forge

# List packages depending on `progressbar2`:
mamba repoquery whoneeds progressbar2 --channel conda-forge

# List dependencies of `progressbar2`:
mamba repoquery depends progressbar2 --channel conda-forge
```
